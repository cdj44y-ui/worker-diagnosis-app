...
표기된 사건번호·선고일 검증 요약은 [`docs/legal-citations.md`](./docs/legal-citations.md)를 참고하세요.
...
별도 서비스 **근로감독 자가진단**(`labor-inspection-app`)은 랜딩·진단 화면 헤더에서 **[근로감독 진단 사이트](https://risk119.site)** 로 연결됩니다.  
배포 URL이 다르면 프로젝트 루트에 `.env` 를 두고 다음을 설정하세요.
